...
public class BookDemo {
	...
	public static void main(String[] args) {
		...
		Comparator<Book> cmpBookByYear = Comparator.comparing(Book::getYear).reversed().thenComparing(Book::getRating);
		...
		for (Book b : books) {
			List<Book> authorsBooks = authorMap.get(b.getAuthor());
			...
			// Author -> List[Books]
			authorMap.put(b.getAuthor(), authorsBooks);
		}
